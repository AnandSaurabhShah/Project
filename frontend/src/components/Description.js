                ...
                >
                    ...
                    <Grid container spacing={4} data-aos='fade-up'>
                        <DescriptionItem
                            ...
                            icon={EditIcon}
                            title='Fill the Form'
                            subtitle='First, fill the form to best of your knowledge show it can give you predicted Autism Probability precisely.'
                        />
                        <DescriptionItem
                            color={theme.palette.error.dark}
                            icon={ShareSquareIcon}
                            title='Send the Data for Prediction'
                            subtitle='Click on Submit button to know the prediction of model.'
                        />
                        <DescriptionItem
                            color={theme.palette.primary.main}
                            icon={LaptopCodeIcon}
                            title='Get the Prediction Result'
                            subtitle='Once you have sent your data to the machine learning model, the model  returns the percentage of Autism.'
                        />
                        <DescriptionItem
